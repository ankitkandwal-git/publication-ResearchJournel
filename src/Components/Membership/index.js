...
const membershipInfo = [
    {
        id: 1,
        title: 'Content',
        content: `Society for Promoting Academic Collaboration and Engagement (S.P.A.C.E.) is committed to provide a network of Scholars, Academicians, Researchers, Industry Experts and Members of all levels to make a community of repute to exchange knowledge on current issues. 
                S.P.A.C.E. Membership is to provide technical services and other assistance for the research activities for those who subscribe for membership. Scholars, Academicians, Researchers and Industry Experts can get S.P.A.C.E. Membership. 
                It provides a platform for sharing technical knowledge with support of Scholars, Academicians, Researchers, Industry Experts and Members. It also supports in publication of Books, 
                Research Papers, organizing conferences, seminars, workshops, etc.`
    },
    {
        id: 2,
        title: 'Eligible for membership',
        content: `Candidate must be a master's degree holder and must be a professional from any field of engineering, medical science, basic & applied science, pharmacy, nursing, agriculture science, veterinary science, law, social sciences, education and management etc.
    ...
    },
    {
        ...
        content: `Annual Membership is valid for one year from the date of issue of Certificate of Annual Membership while Lifetime Membership is 
    ...
    },
    {
        ...
        content: `1. It adds value to the curriculum.
                ...
                5. 25% discount will be given to the S.P.A.C.E. Members in Publication of Research paper in SPACE Journal of Research and Review (Journal of S.P.A.C.E.).
